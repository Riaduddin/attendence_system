...
from src.configuration import ConfigurationsPOJO
...
class FacePredictor():
    ...
    def CosineSimilarity(test_vec,source_vecs):
        ...
        for source_vec in source_vecs:
            cost_dist=FacePredictor.findCosineDistance(test_vec,source_vec)
        return cost_dist/len(source_vecs)
            ...
            if frames %3 ==0:
                ...
                if len(bboxes)!=0:
                    for bboxe in bboxes:
                        ...
                        cv2.putText(frame,text,(bbox[0],y),cv2.FONT_HERSHEY_SIMPLEX,.95,(255,255,255),1)
                ...
                for tracker,text in zip(trackers,texts):
                    ...
                    cv2.putText(frame,text,(startX,startY-15),cv2.FONT_HERSHEY_SIMPLEX,.95,(255,255,255),1)
